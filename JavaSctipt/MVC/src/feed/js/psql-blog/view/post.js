const post = (() => {
  class _Post {
    constructor(header, body, image, key, postid) {
      this.header = header;
      this.body = body;
      this.image = image;
      this.key = key;
    ...
    setClassNames() {
      this.backgroundImageContainer.className = 'Post-image';
  ...
  const createNewPost = (header, body, image, key, postid) => {
    const newPost = new _Post(header, body, image, key, postid);
